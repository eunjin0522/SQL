...
COMMENT ON COLUMN "MEMBER"."MEM_ID" IS 'MEMBER_ID
영문자,숫자   ,    _   ,  /';

COMMENT ON COLUMN "MEMBER"."MEM_PWD" IS '맴버비밀번호
영문자,숫자,   !_ -   ~';
...
COMMENT ON COLUMN "LOGIN_LOG"."LOG_TIME" IS 'ms나옴';

COMMENT ON COLUMN "LOGIN_LOG"."LOG_IP" IS '로그인한 단말의 IPv4
(000.000.000.000)';

COMMENT ON COLUMN "LOGIN_LOG"."MEM_ID" IS 'MEMBER_ID
영문자,숫자   ,    _   ,  /';

COMMENT ON COLUMN "LOGIN_LOG"."LOG_TYPE" IS 'login(1)
logout(0)';
...
COMMENT ON COLUMN "BOARD"."LOG_IP" IS '글작성시단말의 IPv4';

COMMENT ON COLUMN "BOARD"."BOARD_WRITER" IS 'MEMBER_ID
영문자,숫자   ,    _   ,  /

on delete set null : 게시물 유지
-FK 못 묶음, null로설정
ondelete cascate : 게시물도 삭제';

COMMENT ON COLUMN "BOARD"."READ_COUNT" IS '글읽기시 +1';
...
COMMENT ON COLUMN "BOARD_REPORT"."MEM_ID" IS 'MEMBER_ID
영문자,숫자   ,    _   ,  /';
...
CREATE TABLE "BOARD_FILE" (
	...
	"BOARD_ID"	NUMBER		NOT NULL,
	"ORIFINAL_FILENAME"	varchar2(300)		NOT NULL,
	"SAVED_FILE_PATH_NAME"	varchar2(1000)		NOT NULL
);

COMMENT ON COLUMN "BOARD_FILE"."BOARD_FILE_ID" IS 'BOARD_ID마다1씩자동증가';

COMMENT ON COLUMN "BOARD_FILE"."BOARD_ID" IS '글번호 SEQ_BOARD_ID';

COMMENT ON COLUMN "BOARD_FILE"."ORIFINAL_FILENAME" IS '클라이언트전송한파일명';

COMMENT ON COLUMN "BOARD_FILE"."SAVED_FILE_PATH_NAME" IS '저장된파일경로파일명(YYYYMMDDHHMISS_0001.TXT)';
...
CREATE TABLE "BOARD_REPLY" (
	...
	"BOARD_REPLY_STEP"	NUMBER(3)	DEFAULT 1	NULL
);
...
COMMENT ON COLUMN "BOARD_REPLY"."MEM_ID" IS 'MEMBER_ID
영문자,숫자   ,    _   ,  /';
